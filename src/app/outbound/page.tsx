  ...
  return (
    <div className="bg-black text-white min-h-screen font-['Gill_Sans',_'Gill_Sans_MT',_Calibri,_sans-serif]">
      ...
      <section className="pt-32 pb-16 text-center">
        <h1 className="text-4xl md:text-6xl font-black mb-8 uppercase tracking-tight">Outbound AI Agent</h1>
        <p className="text-xl text-white/80 mb-8 max-w-3xl mx-auto">Automate outbound calls for reminders, collections, notifications, surveys, and more. Reach thousands instantly with personalized, interactive voice calls—no human agent required.</p>
      </section>
